...
#include "../Pankkiautomaatti/tilitapahtumat.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Tilitapahtumat_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 47, 27)
    ...
    "Tilitapahtumat\0on_pushButton_Takaisin_clicked\0"
    "\0on_pushButton_nayta_clicked"
};
...
void Tilitapahtumat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pushButton_nayta_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Tilitapahtumat::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Tilitapahtumat.data,
      qt_meta_data_Tilitapahtumat,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Tilitapahtumat.stringdata))
